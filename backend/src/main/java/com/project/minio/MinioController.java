...
import com.project.config.security.UserDetailsImpl;
...
import com.project.util.converter.BreadcrumbConverter;
...
public class MinioController {
    ...
    @DeleteMapping
    public String deleteFile(@AuthenticationPrincipal UserDetailsImpl userDetails, @RequestParam("isDir") Boolean isDir, @RequestParam("file") String filePath){
        String pathToFileDirectory = minioService.removeFile(filePath,isDir, userDetails.getUserId());
